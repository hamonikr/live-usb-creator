    ...
    ui(new Ui::MainWindow)
{
    ...
    // setup options
    LUM.clear();
    QFileInfo settingsfile("/etc/live-usb-creator/live-usb-creator.conf");
    QSettings settings("/etc/live-usb-creator/live-usb-creator.conf", QSettings::NativeFormat);
...
{
    QString url = "/usr/share/doc/live-usb-creator/live-usb-creator.html";
